...
class RichSendService : Service() {
    ...
    private fun extractAttachmentsFromSession(sessionId: String): List<com.samc.replynoteapp.HistoryAttachment> {
        return try {
            ...
            val list = mutableListOf<com.samc.replynoteapp.HistoryAttachment>()
            for (i in 0 until arr.length()) {
                val o = arr.getJSONObject(i)
                list.add(
                    com.samc.replynoteapp.HistoryAttachment(
            ...
            list
        } catch (t: Throwable) { emptyList<com.samc.replynoteapp.HistoryAttachment>() }
    }
    ...
    companion object {
        ...
        const val ACTION_START = "com.samc.replynoteapp.RichSendService.START"
        const val ACTION_CANCEL = "com.samc.replynoteapp.RichSendService.CANCEL"
        const val ACTION_RESUME = "com.samc.replynoteapp.RichSendService.RESUME"
