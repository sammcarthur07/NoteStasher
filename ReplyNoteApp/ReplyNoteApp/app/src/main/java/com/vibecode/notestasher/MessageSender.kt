...
object MessageSender {
    ...
    suspend fun sendMessageToGoogleDoc(
        ...
        try {
            ...
            val docId = SharedPreferencesHelper.loadSelectedDocId(context)
            val docName = SharedPreferencesHelper.loadDocDisplayName(context, docId)
            SharedPreferencesHelper.saveMessageToHistory(context, message, docId, docName)
